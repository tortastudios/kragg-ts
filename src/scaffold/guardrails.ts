 ...
 * this one name whenever the pin is written. See `supplyChain.ts`.
 */
...
/** Whether the generated manifest pins `kragg-ts`, i.e. this build is a released version. */
function selfPinned(manifest: Readonly<Record<string, unknown>>): boolean {
  const dev = manifest["devDependencies"];
  return typeof dev === "object" && dev !== null && Object.hasOwn(dev, "kragg-ts");
}
...
released kragg, \`kragg-ts\` itself, for the reason written beside it in that
