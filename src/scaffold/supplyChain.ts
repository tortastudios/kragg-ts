...
/**
 * Why `@tortastudios/kragg-ts` itself is exempt, in a project generated by a released kragg.
 *
 ...
 */
const SELF_PIN_WHY = `#
# \`@tortastudios/kragg-ts\`: the kragg that generated this project. package.json pins it at
 ...
 * pin. `selfPinned` says whether the generated `package.json` pins
 * `@tortastudios/kragg-ts`,
